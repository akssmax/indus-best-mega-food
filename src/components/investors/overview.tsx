  ...
  return (
    <Section>
      <div className="grid gap-6 lg:grid-cols-2">
        <Reveal>
          <div className="flex h-full flex-col rounded-xl bg-forest p-6 text-forest-foreground sm:p-8">
        ...
        {scheme ? (
          <Reveal delay={0.08}>
            <div className="flex h-full flex-col rounded-xl bg-card p-6 ring-1 ring-foreground/8 sm:p-8">
