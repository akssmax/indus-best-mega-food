...
export type PlatformCapabilityTab = {
  id: string
  label: string
  style: FacilityCategoryStyle
  icon: FacilityIcon
...
export const platformCapabilityTabs: PlatformCapabilityTab[] = [
  {
    id: "processing",
    label: "Processing",
    style: facilityCategories[0].style,
    icon: facilityCategories[0].icon,
    items: facilityCategories[0].items,
  },
  {
    id: "cold",
    label: "Cold chain",
    style: facilityCategories[1].style,
    icon: facilityCategories[1].icon,
    items: facilityCategories[1].items,
  },
  {
    id: "warehousing",
    label: "Warehousing",
    style: facilityCategories[2].style,
    icon: facilityCategories[2].icon,
    items: facilityCategories[2].items,
  },
  {
    id: "quality-utilities",
    label: "Quality & utilities",
    style: "quality",
    icon: ClipboardDocumentCheckIcon,
    items: [
      ...facilityCategories[3].items,
      ...facilityCategories[4].items,
    ],
  },
]
