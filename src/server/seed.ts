...
import { authors, categories, media, pageSections, posts, siteSettings } from "./schema"
import { getDefaultHomeSections } from "@/content/home-sections.registry"
...
async function seedCmsContent() {
  ...
  if (existingSections.length === 0) {
    await db.insert(pageSections).values(getDefaultHomeSections())
    console.log("Seeded: home page sections.")
  }

  console.log("Seeded: site settings row.")
}
